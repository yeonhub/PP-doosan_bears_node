export const DoosanPlayerData = [
    ...
    },
    {
        ...
        name: '양의지',
        nameno: 'yej25',
        imgurl: "./images/yej25.png",
        position: "포수",
        birth: '1987년 6월 5일',
        birth2: '광주광역시 광산구 송정동',
        nation: '대한민국',
        eb: '송정동초 - 무등중 - 광주진흥고',
        phy: '180cm | 94kg | A형',
        po: '포수, 지명타자, 1루수',
    ...
    },
    {
        ...
        images: [
            ...
            { tn: "./images/kjh52/kjh52-3.jpg" }
        ],
        club: [
            { c: '두산 베어스 (2004~)' },
            { c: '상무 피닉스 야구단 (2006~2007)' },
        ],
        youtube: [
            { yt: "fy4XKcryqDk" },
            { yt: "2WU2DaKnon0" },
...
export const statDataMap = DoosanPlayerData.map(player => player.nameno)